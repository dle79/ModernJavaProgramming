...
public class LambdaLibrary {
	...
	static Function<Stream<Integer>, Integer> FIND_MAX_STREAM = streamArray ->
		streamArray.max(Integer::compare).get();
	
	static Function<Stream<Integer>, Integer> FIND_MIN_STREAM = streamArray ->
		streamArray.min(Integer::compare).get();
		
	static Function<IntStream, Integer> FIND_MAX_INTSTREAM =  intStreamArray -> 
		intStreamArray.max().getAsInt();
