package lesson7.lab7.prob1.part_C;
...
public class EmployeeInfo {
	...
	/**
	 * Returns true if the two lists have the same size and contain exactly the
	 * same elements (this is really just set equality)
	 */
