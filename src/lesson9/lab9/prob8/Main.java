...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(LambdaLibrary.COUNT_EMPLOYEE_WITH_GIVEN_CONDITION.apply(list, "E", 100000));
		...
		// before the letter 'R'
		System.out.println(LambdaLibrary.GET_LIST_OF_EMPLOYEE_WITH_GIVEN_CONDITION.apply(list, "R", 85000));
	}
